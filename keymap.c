...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_planck_grid(
      ...
      _______, _______, _______, _______, _______, _______, _______, KC_UNDS, KC_LCBR, KC_RCBR, KC_COLN, KC_PIPE,
      _______, _______, _______, _______, _______, _______, _______, KC_PLUS, KC_LABK, KC_RABK, KC_QUES, KC_DQUO,
  ...
  [_RAISE] = LAYOUT_planck_grid(
      ...
      _______, _______, _______, _______, _______, _______, _______, KC_MINS, KC_LBRC, KC_RBRC, KC_SCLN, KC_BSLS,
      _______, _______, _______, _______, _______, _______, _______, KC_EQL,  KC_COMM, KC_DOT,  KC_SLSH, KC_QUOT,
      _______, _______, _______, _______, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
  ),
